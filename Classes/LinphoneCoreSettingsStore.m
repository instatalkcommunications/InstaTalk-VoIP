...
- (void)transformLinphoneCoreToKeys {
	...
	if (cfg){
		...
		if (addr){
            ...
            NSString *domain = InstaTalkDomain;
            if (linphone_core_is_network_reachable(lc))
            {
                @try {
                    domain = [BDHost addressForHostname:InstaTalkDomain];
                }
			...
			[self setObject:domain forKey:@"domain_preference"];
            //[self setObject:InstaTalkDomain forKey:@"domain_preference"];
    ...
    //lalit 12 Jan 2015
    [self setBool:0 forKey:@"advanced_account_preference"];
    ...
    [self setBool:FALSE   forKey:@"speex_16k_preference"];
    [self setBool:FALSE   forKey:@"speex_8k_preference"];
    [self setBool:FALSE   forKey:@"opus_preference"];
    [self setBool:FALSE   forKey:@"silk_16k_preference"];
    [self setBool:FALSE   forKey:@"aaceld_16k_preference"];
    [self setBool:FALSE   forKey:@"aaceld_22k_preference"];
    [self setBool:FALSE   forKey:@"aaceld_32k_preference"];
    [self setBool:FALSE   forKey:@"aaceld_44k_preference"];
    [self setBool:FALSE   forKey:@"aaceld_48k_preference"];
    [self setBool:FALSE   forKey:@"amr_preference"];
    [self setBool:FALSE   forKey:@"g722_preference"];
    [self setBool:FALSE   forKey:@"g729_preference"];
    [self setBool:FALSE   forKey:@"ilbc_preference"];
    [self setBool:FALSE   forKey:@"pcmu_preference"];
    [self setBool:FALSE   forKey:@"pcma_preference"];
    [self setBool:FALSE   forKey:@"video_menu"];
    [self setBool:FALSE   forKey:@"call_menu"];
    [self setBool:FALSE   forKey:@"network_menu"];
    [self setBool:FALSE   forKey:@"release_button"];
    [self setBool:FALSE   forKey:@"battery_alert_button"];
    [self setBool:TRUE   forKey:@"silk_24k_preference"];
    [self setBool:FALSE   forKey:@"gsm_preference"];
	[changedDict release];
	changedDict = [[NSMutableDictionary alloc] init];
...
- (void)synchronizeAccount {
	...
	if (username && [username length] >0 && domain && [domain length]>0) {
        ...
        //lalit 12 Jan 2015
        NSString* proxyAddress = nil;//[self stringForKey:@"proxy_preference"];
...
- (BOOL)synchronize {
    ...
    //lalit 12 Jan 2015
    lp_config_set_int(config, LINPHONERC_APPLICATION_KEY, "advanced_account_preference", 0);
