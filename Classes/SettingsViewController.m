...
- (void)viewDidAppear:(BOOL)animated {
    ...
    /*UIBarButtonItem *buttonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"About", nil) style:UIBarButtonItemStylePlain target:self action:@selector(onAboutClick:)];
