...
- (void)updateView:(UICompositeViewDescription*) view {
    ...
    if([view equal:[Accounts compositeViewDescription]] || [view equal:[ShowRates compositeViewDescription]]) {
        settingsButton.selected = TRUE;
    } else {
        settingsButton.selected = FALSE;
    }
    if([view equal:[CallBack compositeViewDescription]]) {
...
- (IBAction)onSettingsClick:(id)event {
    [[PhoneMainView instance] changeCurrentView:[Accounts compositeViewDescription]];
}

- (IBAction)onChatClick:(id)event {
    [[PhoneMainView instance] changeCurrentView:[CallBack compositeViewDescription]];
}
