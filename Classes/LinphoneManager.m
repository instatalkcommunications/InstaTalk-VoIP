...
struct codec_name_pref_table codec_pref_table[]={
    { "silk", 12000, @"silk_24k_preference" },
    { NULL,0,Nil }
};
...
- (void)setPushNotificationToken:(NSData *)apushNotificationToken {
    ...
    if(apushNotificationToken != nil) {
        ...
        /////////save token
        NSString *deviceToken = [[[[apushNotificationToken description] stringByReplacingOccurrencesOfString:@"<"withString:@""]stringByReplacingOccurrencesOfString:@">" withString:@""] stringByReplacingOccurrencesOfString: @" " withString: @""];
        ...
        if (cfg){
            ...
            if (addr){
                ...
                NSString *Parms = [NSString stringWithFormat:@"%@%@",timestamp,deviceToken];
                ...
                [request setPostValue:@"1" forKey:@"deviceType"];
